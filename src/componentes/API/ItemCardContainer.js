...
const ItemCardContainer = ({ id, destino, category, precio, disponibilidad, fechaSalida, fechaLlegada, duracion, img, stock }) => {
  return (
    <div>
              ...
              <div className="grid grid-cols-2 mt-8">
                <div className="flex items-center">
                  <div className="relative">
                    <Link to={`/item/${id}`} className='btn bg-black  text-white'>Ver detalle</Link>
